...
public class DBService {
    ...
    public void instanciaDB(){
        Tecnico tec1 = new Tecnico(null, "Bruno", "45111889809", "bruno@gmail.com", "123");
        tec1.addPerfil(Perfil.ADMIN);
        Tecnico tec2 = new Tecnico(null, "Dauane", "31158526067", "dauane@gmail.com", "123");
        tec2.addPerfil(Perfil.ADMIN);
        Tecnico tec3 = new Tecnico(null, "Paulina", "14565829096", "paulina@gmail.com", "123");
        tec3.addPerfil(Perfil.ADMIN);

        Cliente cli1 = new Cliente(null, "Julia", "09622413005", "julia@gmail.com", "123");
        Cliente cli2 = new Cliente(null, "Shell", "09980483059", "shell@gmail.com", "123");
        Cliente cli3 = new Cliente(null, "Lucas", "33021071023", "lukito@gmail.com", "123");
